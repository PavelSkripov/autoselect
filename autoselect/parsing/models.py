...
class Sensor(models.Model):
    ...
    sensing_distance = models.FloatField(null=True, blank=True)
    ...
    cable_length = models.FloatField(null=True, blank=True)
    housing = models.CharField(max_length=30, null=True, blank=True)
    standard_size = models.FloatField(null=True, blank=True)
    ...
    num_wires = models.FloatField(null=True, blank=True)
    ...
    hole_diameter = models.FloatField(null=True, blank=True)
    slot_width = models.FloatField(null=True, blank=True)
...
class Analog(models.Model):
    ...
    difference = models.JSONField(null=True, blank=True)
    mark = models.CharField(max_length=40, null=True, blank=True)
    difference1 = models.JSONField(null=True, blank=True)
    mark1 = models.CharField(max_length=40, null=True, blank=True)
    difference2 = models.JSONField(null=True, blank=True)
    mark2 = models.CharField(max_length=40, null=True, blank=True)
    difference3 = models.JSONField(null=True, blank=True)
    mark3 = models.CharField(max_length=40, null=True, blank=True)
    difference4 = models.JSONField(null=True, blank=True)
    mark4 = models.CharField(max_length=40, null=True, blank=True)
    manufacture_original = models.CharField(max_length=30, null=True, blank=True)
